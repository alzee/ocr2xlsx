    ...
    def main(
        ...
        for file in files:
            if file.is_file():
                ...
                client = Sample.create_client(os.getenv('ALI_KEY_ID'), os.getenv('ALI_KEY_SECRET'))
                ...
                try:
                    # res = client.recognize_all_text_with_options(recognize_request, runtime)
                    res = client.recognize_advanced_with_options(recognize_request, runtime)
                    # res = client.recognize_general_with_options(recognize_request, runtime)
